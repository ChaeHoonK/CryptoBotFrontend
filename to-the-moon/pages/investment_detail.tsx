...
const sample_history = [
  { market: "BTC-KRW", amount: 300, date: "03/01/23", type: "Sell" },
  { market: "BTC-KRW", amount: 200, date: "02/28/23", type: "Sell" },
  { market: "BTC-KRW", amount: 500, date: "02/27/23", type: "Buy" },
];
  ...
  return (
    <div className={styles.main}>
      ...
      <TabPanel value={value} index={1}>
        ...
        <div style={{border:'1px solid #E14D28', borderRadius:'20px',padding:'10px',margin:'0px 10px 0px', backgroundColor:'white'}}>
          <h3>Trade History</h3>
          <br />
